...
sub Data {
    ...
    $Self->{Translation}->{'Dynamic Field Config Item'} = 'Konfigurációelem dinamikus mező';
    ...
    $Self->{Translation}->{'Ticket event module that updates dynamic fields.'} = 'Jegyeseménymodul, amely frissíti a dinamikus mezőket.';
    $Self->{Translation}->{'class'} = 'osztály';
